...
import { Outlet, Link as RemixLink, Form, useLoaderData, useNavigation } from "@remix-run/react";
import type { LoaderArgs } from "@remix-run/node";
import { json } from "@remix-run/node";
import { useState } from "react";
import { Chair } from "~/assets";
import { Button, FlexHeader, FlexList, Link, Loader, MaxWidth, MobileModal, Navbar, Title } from "~/components";

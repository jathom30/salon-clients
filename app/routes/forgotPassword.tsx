      ...
      <FlexList pad={4}>
        {emailSuccess ? (
          <>
            ...
            <span className="text-center text-sm">We sent a password reset link to <strong>{emailSuccess}</strong></span>
            <ItemBox>
              <Form method="put">
                <span className="text-center text-sm">Didn't receive the email? <button name="intent" value="resend" className="link link-accent">Click to resend</button></span>
              </Form>
            </ItemBox>
          </>
        ) : (
          <>
            ...
            <span className="text-center text-sm">No worries, we'll send you reset instructions.</span>
            <ItemBox>
              <Form method="put">
                <FlexList>
